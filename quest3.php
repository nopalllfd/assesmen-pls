...
ob_start();
$questions = [
    "3.	Jika diberi guru tugas, yang mana akan anda pilih untuk <b>dikerjakan</b>?" => ["a. Membuat Puisi", "b. Senam", "c. Meneliti Tumbuhan", "d. Membuat Kerajinan"],
...
<body class="mx-auto">
    ...
    if (isset($_POST['submit'])) {
        ...
        foreach ($correct_answers as $key => $correct_answer) {
            ...
            if (isset($answers[$question])) {
                ...
                switch ($answers[$question]) {
                    case 'a':
                       $_SESSION['countA']++;
                       $sql = "UPDATE `question` SET `a3` = '$answers[$question] ' WHERE `question`.`id_user` = '$noreg';";
        ...
        header("Location: quest4.php?message=$_GET[message]");
