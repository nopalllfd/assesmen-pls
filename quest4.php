...
ob_start();
$questions = [
    "4.	Diantara pilihan berikut, mata Pelajaran yang paling anda <b>sukai</b> adalah …
" => ["a. Seni Budaya", "b. Penjas/PJOK", "c. Matematika/IPA", "d. PKN"],
        ...
        foreach ($correct_answers as $key => $correct_answer) {
            ...
            if (isset($answers[$question])) {
                ...
                switch ($answers[$question]) {
                    case 'a':
                        $_SESSION['countA']++;
                        $sql = "UPDATE `question` SET `a4` = '$answers[$question] ' WHERE `question`.`id_user` = '$noreg';";
            ...
            header("Location: quest5.php?message=$_GET[message]");
