...
ob_start();
$questions = [
    "5.	Jika di beri hadiah, anda akan paling senang jika mendapatkan …
" => ["a. Lukisan", "b. Bola", "c. Rubiks Cube", "d. Kain Sasirangan"],
        ...
        foreach ($correct_answers as $key => $correct_answer) {
            ...
            if (isset($answers[$question])) {
                ...
                switch ($answers[$question]) {
                    case 'a':
                        $_SESSION['countA']++;
                        $sql = "UPDATE `question` SET `a5` = '$answers[$question] ' WHERE `question`.`id_user` = '$noreg';";
            ...
            header("Location: quest6.php?message=$_GET[message]");
