...
ob_start();
$questions = [
    "6.	Diantara pilihan berikut, tokoh yang paling anda kagumi adalah …
" => ["a. Leonardo Da Vinci", "b. Mike Tyson", "c. Albert Einstein", "d. Ir. Soekarno"],
        ...
        foreach ($correct_answers as $key => $correct_answer) {
            ...
            if (isset($answers[$question])) {
                ...
                switch ($answers[$question]) {
                    case 'a':
                        $_SESSION['countA']++;
                        $sql = "UPDATE `question` SET `a6` = '$answers[$question] ' WHERE `question`.`id_user` = '$noreg';";
            ...
            header("Location: quest7.php?message=$_GET[message]");
