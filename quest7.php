...
ob_start();
$questions = [
    "7.	Seandainya anda berlibur ke Jakarta, tempat mana yang paling anda ingin kunjungi ?
" => ["a. Balai Sarbini", "b. Gelora Bung Karno/GBK", "c. Museum Monas", "d. Gedung DPR/Istana Negara"],
        ...
        foreach ($correct_answers as $key => $correct_answer) {
            ...
            if (isset($answers[$question])) {
                ...
                switch ($answers[$question]) {
                    case 'a':
                        $_SESSION['countA']++;
                        $sql = "UPDATE `question` SET `a7` = '$answers[$question] ' WHERE `question`.`id_user` = '$noreg';";
            ...
            header("Location: quest8.php?message=$_GET[message]");
